 ...
 */
public class selangor_activity extends AppCompatActivity {

    private String TAG = selangor_activity.class.getSimpleName();
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selangor_layout);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(selangor_activity.this,"Sedang memproses ...",Toast.LENGTH_LONG).show();
        }
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "https://banjir-api.herokuapp.com/api/v1/reports.json?negeri=selangor";
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(selangor_activity.this, banjirList,
