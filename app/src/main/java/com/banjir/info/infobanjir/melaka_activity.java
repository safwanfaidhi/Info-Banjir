 ...
 */
public class melaka_activity extends AppCompatActivity {

    private String TAG = melaka_activity.class.getSimpleName();
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.melaka_layout);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(melaka_activity.this,"Sedang memproses ...",Toast.LENGTH_LONG).show();
        }
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "https://banjir-api.herokuapp.com/api/v1/reports.json?negeri=melaka";
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(melaka_activity.this, banjirList,
