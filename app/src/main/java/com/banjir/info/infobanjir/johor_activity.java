 ...
 */
public class johor_activity extends AppCompatActivity {

    private String TAG = johor_activity.class.getSimpleName();
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.johor_layout);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(johor_activity.this,"Sedang memproses ...",Toast.LENGTH_LONG).show();
        }
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "https://banjir-api.herokuapp.com/api/v1/reports.json?negeri=johor";
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(johor_activity.this, banjirList,
